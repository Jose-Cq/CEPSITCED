...
/**
 * Fetches and aggregates specialist profiles dynamically from the database.
 * Merges landing_personal, empleados, asignaciones, areas, and cargos.
...
export const obtenerEspecialistasLanding = async () => {
  try {
    ...
    console.error('Error in obtenerEspecialistasLanding:', err.message);
    return [];
  }
};
