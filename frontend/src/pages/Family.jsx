...
const Family = () => {
  ...
  const handleSaveMember = async (e) => {
    ...
    try {
      ...
      toast.success('Miembro familiar actualizado exitosamente.');
      setIsEditingMember(false);
      refetch();
      setSelectedMember(data);
    } catch (err) {
      toast.error(err.message || 'Error al guardar los cambios del familiar.');
    } finally {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast.error(err.message || 'Error al registrar el perfil.');
    } finally {
      setIsSubmitting(false);
    }
  };
